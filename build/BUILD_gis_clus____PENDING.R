...
clu <- readOGR(dsn = "CLU/clu_public_a_ca083", layer = "clu_public_a_ca083")
proj4string(clu)
clu <- spTransform(clu, CRS("+proj=longlat +datum=WGS84 +no_defs +ellps=GRS80 +towgs84=0,0,0"))
...
ggplot() + 
  ...
  geom_polygon(data=clu, aes(x=long, y=lat, group=group, color=rgb(0,0,1)), 
