...
## save outputs
#saveRDS(inter, file.path(path_output, "CLU_counties.RDS"))
#inter <- readRDS("C:/Users/clohani/OneDrive/Documents/Intersected_data.rds")
...
saveRDS(union_clus, file.path(path_output, "Intersected_CLU_county.rds"))