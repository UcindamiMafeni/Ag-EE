...
CLU_allocation <- readRDS(file.path(path_output,"CLU_PA_cropctd_assignment_majorOnly.rds"))
write.csv(CLU_allocation, file=file.path(path_output,"CLU_PA_cropctd_assignment_majorOnly.csv") , row.names=FALSE, quote=FALSE)
