...
compress
save "$dirpath_data/pge_cleaned/sp_premise_latlon.dta", replace
...
** 2. Save APEP pump coordinates (techincally *premise* coordinates)
if 1==1{
...
compress
save "$dirpath_data/pge_cleaned/apep_pump_latlon.dta", replace
