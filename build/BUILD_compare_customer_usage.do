...
joinby sa_uuid using "$dirpath_data/pge_cleaned/billing_data.dta", unmatched(both)
assert _merge!=2
...
joinby sa_uuid using "$dirpath_data/pge_cleaned/interval_data_daily.dta", unmatched(both)
assert _merge!=2
