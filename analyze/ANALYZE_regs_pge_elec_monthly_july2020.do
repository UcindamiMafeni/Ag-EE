...
*********************************************************************************************
** Script to run main set of monthly PGE electricity regressions for July 2020 paper draft **
*********************************************************************************************
...
** 1. Monthly regressions (main set of 6 regressions, for 7 outcome+sample combinations)
{ 
...
// Loop over 7 combinations of outcome+sample
foreach c1 of numlist 1/7 {
	...
	foreach c2 of numlist 1/6 {
		...
		// Save output
		if `c1'==1 & `c2'==1 {
			cap erase "$dirpath_data/results/regs_pge_elec_monthly_july2020.dta"
		}
		preserve
		keep panel-fs_t_deflag6
		dropmiss, obs force
		cap append using "$dirpath_data/results/regs_pge_elec_monthly_july2020.dta"
		duplicates drop
		compress
		save "$dirpath_data/results/regs_pge_elec_monthly_july2020.dta", replace
		restore
